...
const overrides = new Map([
  ...
  // Upstream sync 2026-07-26: supervised relay-mesh/runtime changes from main
  // add 4 counted lines while the broader managed-agent runtime split remains queued.
